...
To go along with the armor trim theme, I've also created a new resource pack, called [Armor Trim Consistency](https://modrinth.com/resourcepack/armor-trim-consistency)
...
The goal of this resource pack is to make all textures in Minecraft have consistently sized pixels in-game.
In my opinion, this significantly improves the look and feel of Minecraft, giving it a more coherent visual style.

This project is currently in beta development at roughly **60% complete**, and most of the commonly observed inconsistencies have been fixed.
